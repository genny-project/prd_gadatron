...
public class TestServiceImpl implements TestService {
        ...
        public void createTestMsg() {
                ...
                BaseEntity be = beUtils.getBaseEntityOrNull("MSG_IM_INTERN_APPLIED");
                beUtils.addValue(be, "PRI_MILESTONE", "[\"INTERN_APPLY\"]");

                // ATT_PRI_RECIPIENT_LNK

                beUtils.addValue(be, "PRI_RECIPIENT_LNK", "LNK_INTERN"); // other examples LNK_HOST_COMPANY:LNK_ADMIN
                // ATT_PRI_SENDER_LNK
        ...
        public String getTestBaseEntityApplicationJson(String beCode) {
                ...
                return jsonb.toJson(applicationBE);
        }
