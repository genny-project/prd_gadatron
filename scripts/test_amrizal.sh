...
questionCode=${2:-QUE_BALI_PERSON_GRP}
targetCode=${3:-PER_949F7C8B-7F7F-4505-BDF7-117C3F1231EC}
sourceCode=-PER_5C1491C4-8AA6-40DC-8CAF-F2806D4737C4
content='amrizal fajar'
TOKEN=`./gettoken-cache.sh ${productCode}`
echo $TOKEN
payload="{\"data\":{\"sourceCode\":\"${sourceCode}\",\"targetCode\":\"${targetCode}\",\"code\":\"GADA_AMRIZAL_${questionCode}\", \"content\": \"${content}\"},\"token\":\"${TOKEN}\",\"msg_type\":\"EVT_MSG\"}"
echo $payload
